...
class MultiWindowWindows extends MultiWindowInterface {
  static const MethodChannel _methodChannel =
      const MethodChannel('multi_window_windows');
  ...
  Stream<DataEvent> events(String key, String creatorKey) {
    if (!_eventChannels.containsKey(key)) {
      _eventChannels[key] = EventChannel('multi_window_windows/events/$key');
